...
public class CircleCalcs
{
	static void Main () 
    {
        ...
        if(int.TryParse(input,out radius))
        {
            ...
            {
                Console.WriteLine("A circle with radius {0} has a circumference of {1:0.00} and area of {2:0.00}.", radius, c, a);
            }
            else
            {
...
/*
Enter the radius: 1
A circle with radius 1 has a circumference of 6,28 and area of 3,14.
